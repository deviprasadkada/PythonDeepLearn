...
#setting the batchsize and epochs
batch_size = 60
nb_classes = 10
nb_epoch = 100
...
#performing lineaer regression
model = Sequential()
model.add(Dense(output_dim=10, input_shape=(784,), init='normal', activation='relu'))
model.compile(optimizer='SGD', loss='mean_squared_error', metrics=['accuracy'])
model.summary()

#tensorboard log genertion for graphs
tensorboard = TensorBoard(log_dir="logsl2/{}",histogram_freq=0, write_graph=True, write_images=True)

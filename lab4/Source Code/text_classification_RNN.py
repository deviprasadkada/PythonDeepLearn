...
#Loading dataset
tweets = pd.read_csv('C://Users//KDEVI//Pycharm programs//DeepLearning_SourceCode4//collection.csv', sep=',')
tweets.head(2)
...
model.add(SimpleRNN(lstm_out, dropout=0.5, recurrent_dropout=0.5))
...
plt.plot(epochs, loss, 'bo', label='Training loss',color='brown')
...
plt.plot(epochs, acc, 'bo', label='Training acc',color='yellow')
